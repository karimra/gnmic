...
function cleanup() {
  echo "gnmic_config_file: ./clab/loaders/gnmic-docker-loader.yaml" > clab/loaders/loaders.clab_vars.yaml
...
echo "gnmic_config_file: ./clab/loaders/gnmic-file-loader.yaml" > clab/loaders/loaders.clab_vars.yaml
