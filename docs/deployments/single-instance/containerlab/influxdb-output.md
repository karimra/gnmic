...
- [Grafana datasource](https://github.com/karimra/gnmic/blob/master/examples/deployments/containerlab/1.single-instance/3.influxdb-output/grafana/datasources/datasource.yaml)
